...
//  Vocaltale
//
//  Created by Kei Sau CHING on 2022/10/12.
//
    ...
    var body: some View {
        ZStack {
            ...
            Image(systemName: "repeat")
                ...
                .foregroundColor(
                    audioPlayerRepository.isLoop ? .primary : Color(nsColor: .disabledControlTextColor)
                )
    ...
    var body: some View {
        ZStack {
            ...
            Image(systemName: "shuffle")
                ...
                .aspectRatio(contentMode: .fit)
                .foregroundColor(
                    audioPlayerRepository.isShuffle ? .primary : Color(nsColor: .disabledControlTextColor)
                )
                .padding(kControlButtonsPaddings)
        }
        .onHover { value in
